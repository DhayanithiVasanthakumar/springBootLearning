...
public class UserController {
	...
	// CREATE
	@PostMapping("addUser")
	public String addUser(@RequestBody UserDetails userObj) {
		System.out.println("User obj passed -> " + userObj.toString());
		userDAO.saveUser(userObj);// model ooda obj ah db la store pani vaikum,-> so that's why we create pojo
									// class .
...
//		// munnadi itha execption ah handle panitu irunthanga, ipa "Optional" muliyam ah
//		// handle panaranga
